...
<div class="row" >
    <div class="col-lg-12">
        <div class="title-action" style="margin-left: 3%;">
            ...
            <a href="Templates/layout/sales-invoice/<?php echo $sales_info->sales_invoice_id; ?>?type=html" target="_blank" class="btn btn-default" style="text-transform:none;font-family: tahoma;" ><i class="fa fa-print"></i> Print SI</a>
