                                ...
                                <div class="col-md-12">
                                    ...
                                    <div id="div_payable_list">
                                        ...
                                        <div class="panel-group panel-default" id="accordionA">
                                            ...
                                            <div class="panel panel-default" style="border-radius: 0px;min-height: 670px;">
                                                ...
                                                <div id="collapseTwo" class="collapse in">
                                                    <div class="panel-body">
                                                        ...
                                                        <div style="border: 1px solid #a0a4a5;padding: 1%;border-radius: 5px;padding-bottom: 2%;">
                                                            <table id="tbl_inventory" class="custom-design table-striped" cellspacing="0" width="100%">
                                                                <thead class="">
                                                                <tr>
                                                                    <th width="5%"></th>
                                                                    <th width="15%">PLU</th>
